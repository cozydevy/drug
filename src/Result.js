...
export default function Result() {
  ...
  const resultList = (dataInteract || []).map((item, i) => (
    <Grid>
      ...
      <Grid item xs={12} py={2}>
        <Chip label="severity" variant="outlined" color="primary" />
      </Grid>
      ...
      <Grid item xs={12} py={2}>
        <Chip label="documentation" variant="outlined" color="primary" />
      </Grid>
      <Grid item xs={12} key={i}>
        {" "}
        <Typography variant="h6" component="h6" p={1}>
      ...
      <Grid item xs={12} py={2}>
        <Chip label="clarification" variant="outlined" color="primary" />{" "}
      </Grid>
      <Grid item xs={12} key={i}>
        {" "}
        <Typography variant="h6" component="h6" p={1}>
      ...
      <Grid item xs={12} py={2}>
        <Chip label="reference" variant="outlined" color="primary" />
      </Grid>
      <Grid item xs={12} key={i}>
        {" "}
        <Typography variant="h6" component="h6" p={1}>
